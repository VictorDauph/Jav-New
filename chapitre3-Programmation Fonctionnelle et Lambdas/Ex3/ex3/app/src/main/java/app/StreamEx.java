...
public class StreamEx {
    public static void main(String[] args) {
        ...
        Stream.iterate(0, n -> n + 3)  // Génère les multiples de 3
              .takeWhile(n -> n <= 40) // Garde les valeurs inférieures ou égales à 40
        ...
        Stream.iterate(0, n -> n + 3)  // Génère une séquence de nombres
              .dropWhile(n -> n < 20)  // Ignore tous les nombres inférieurs à 20
              .takeWhile(n -> n <= 40) // Garde les nombres jusqu'à 40
              .forEach(System.out::println);
    }
